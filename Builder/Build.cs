...
{
   public static string ProjectName = "BitArmory.Turnstile";
   public static string GitHubUrl = "https://github.com/BitArmory/Turnstile";
   ...
   public static class Files
   {
      ...
      public static AbsolutePath SolutionFile = RootDirectory / $"{ProjectName}.sln";
      public static AbsolutePath SnkFile = RootDirectory / $"{ProjectName}.snk";
      public static AbsolutePath SnkZipFile = RootDirectory / $"{ProjectName}.snk.zip";
      public static AbsolutePath SnkPublicFile = RootDirectory / $"{ProjectName}.snk.pub";
   }
   ...
   protected override void OnBuildInitialized()
   {
      ...
      this.NugetProject = this.Solution.BitArmory_Turnstile;
      this.TestProject = this.Solution.BitArmory_Turnstile_Tests;
   }
   ...
   Target Compile => _ => _
    ...
    .Executes(() =>
    {
       ...
       CopyDirectoryRecursively(this.NugetProject.BinFolder(), this.NugetProject.CompileOutput());
   ...
   .Executes(() => {
      ...
      var zipPath = Folders.Package / this.NugetProject.ZipFile();
      Folders.CompileOutput.CompressTo(zipPath);
   ...
   Target Test => _ => _
    ...
    .Executes(async () =>
    {
       ...
       //if( IsServerBuild )
       //{
       //   await Folders.Test.UploadXmlNunit3TestResultsAsync();
       //}
   ...
   Target SetupSnk => _ => _
    ...
    .Executes(() =>
    {
       ...
       var secret = GetVariable<string>("SNKZIP_SECRET");
       Assert.NotNullOrWhiteSpace(secret);

       Assert.FileExists(Files.SnkZipFile);

       Files.SnkZipFile.UnZipWithPasswordTo(RootDirectory, secret);
   ...
   AssemblyInfo.Attribute[] MakeAttributes(bool includeSnk)
   {
      ...
      if (includeSnk)
      {
         var pubKeyBytes = File.ReadAllBytes(Files.SnkPublicFile);
